...
export const isRelevantPastTransition = (transition: Transitions) => {
  return [
...
export const isCustomerReview = (transition: Transitions) => {
  return [
    transitions.REVIEW_1_BY_CUSTOMER,
    transitions.REVIEW_2_BY_CUSTOMER,
  ].includes(transition);
...
export const isProviderReview = (transition: Transitions) => {
  return [
    transitions.REVIEW_1_BY_PROVIDER,
    transitions.REVIEW_2_BY_PROVIDER,
  ].includes(transition);
...
// enough.
export const isPrivileged = (transition: Transitions) => {
  return [
...
export const isRefunded = (transition: Transitions) => {
