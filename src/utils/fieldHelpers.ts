 ...
 * @returns
 */
export const getFieldValue = (data: any, key: string) => {
  const value = data?.[key];
  return value != null ? value : null;
};

export const pickCategoryFieldsForProductOrService = (
  data,
  prefix,
  level,
  ...
  const currentCategoryValue = Number(data?.[currentCategoryKey]);
...
export const checkSelected = (options, selectedOptions) => {
