import {Listing, UserProfile} from '../apptypes';
 ...
 */
export const ensureUser = (user: UserProfile) => {
 ...
 */
export const ensureListing = (listing: Listing) => {
  const empty = {
    id: null,
    type: 'listing',
...
/** to make the lighter version of the hex color */
