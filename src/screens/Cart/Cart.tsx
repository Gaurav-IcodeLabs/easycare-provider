    ...
    <View style={styles.outercontainer}>
      {/* <GradientWrapper style={styles.topsection}>
        <View style={styles.headerContainer}>
          <ScreenHeader transparentBackground={true} leftIcon={placeholder}
            rightIcon={magnify} rightIconStyle={styles.right} titleIcon={easycare} leftIconStyle={styles.left}
            onLeftIconPress={()=>console.log('left icon pressed')} />
        </View>
      </GradientWrapper> */}

      <ScreenHeader title="jsdfdf" />
