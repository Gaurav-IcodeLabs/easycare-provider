...
interface BottomSheetTextInputFieldProps<T extends FieldValues>
...
export const BottomSheetTextInputField = <T extends FieldValues>({
  control,
  name,
  labelKey,
  style = {},
  ...
  rightView,
  ...textInputProps
}: BottomSheetTextInputFieldProps<T>) => {
