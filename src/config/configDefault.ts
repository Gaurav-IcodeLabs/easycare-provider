...
import {
  MARKETPLACE_ROOT_URL,
  IOS_GOOGLE_CLIENT_ID,
  IOS_GOOGLE_CLIENT_ID_REVERSE,
...
const defaultConfig = {
  ...
  marketplaceRootURL: MARKETPLACE_ROOT_URL,
  google: {
    ios_google_client_id: IOS_GOOGLE_CLIENT_ID,
    ios_google_client_id_reverse: IOS_GOOGLE_CLIENT_ID_REVERSE,
    google_web_client_id: GOOGLE_WEB_CLIENT_ID,
  },
  apple: {
    ios_apple_client_id: IOS_APPLE_CLIENT_ID,
  },
  ...
  marketplaceName: MARKETPLACE_NAME || 'Biketribe',
